...
async def send_start(client: pyrogram.client.Client, message: pyrogram.types.messages_and_media.message.Message):
    await bot.send_message(message.chat.id, f"__👋 Selam **{message.from_user.mention}**, Ben Kisitli Icerik Kurtarma Botu! Bana post linklerini gonder, gerisini ben hallederim!__\n\n{USAGE}",
    reply_markup=InlineKeyboardMarkup([[ InlineKeyboardButton("🌐 Kaynak Kodu", url="https://github.com/bipinkrish/Save-Restricted-Bot")]]), reply_to_message_id=message.id)
...
__Sadece post linkini/linklerini gonder.__

**OZEL KANALLAR ICIN**

__Once sohbetin davet linkini gonder (eger string session hesabi zaten sohbetin uyesi ise gerek yok)
Sonra post linkini/linklerini gonder.__

**BOT SOHBETLERI ICIN**

__'/b/', botun kullanici adini ve mesaj ID'sini iceren linki gonder.
**COKLU POSTLAR ICIN**

__herkese acik/ozel post linklerini "baslangic - bitis" formatiyla gondererek birden fazla mesaj gonderebilirsin. https://t.me/bptchat/0-9999, https://t.me/c/bptchat/31 - 69 gibi__
